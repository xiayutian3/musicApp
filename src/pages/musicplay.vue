<template>
  <div class="play">
   ...
   <div class="song-info">
        ...
        <Lrc :durationTime="durationTime" :currentTime="currentTime" :songid="$route.params.songid" />
			</div>
			<div class="iconbox">
    ...
    <div class="song">
      ...
      <!-- <video ref="player" :src="currentUrl.bitrate.show_link" controls autoplay></video> -->
		</div>
...
// 异步操作
// const Lrc = Vue.component('lrc',(resolve)=>request(['../components/Lrc'],resolve))
...
export default { 
  ...
  mounted(){
    request.getSingleMusic({songid:this.$route.params.songid},res=>{
